...
class MNIST(object):
    @staticmethod
    def theano_convert_data_set(data, limit=None):
        x, y = data
    ...
    def get_train_set(self, limit=None):
        return self.theano_convert_data_set(self.train_set, limit)

    def get_valid_set(self):
        return self.theano_convert_data_set(self.valid_set)
    ...
    def tf_valid_set(self):
        return self.tf_convert_data_set(self.valid_set)

    def tf_test_set(self):
        return self.tf_convert_data_set(self.test_set)


if __name__ == '__main__':
    mn = MNIST()
    print(mn.get_test_set())
